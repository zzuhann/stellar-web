...
export default function HomePage({ initialArtists = [] }: HomePageProps) {
  ...
  const weekBirthdayArtists = useMemo(() => {
    ...
    const isInitialWeek = currentWeekStart.getTime() === thisWeekStart.getTime();
    const currentArtists = isInitialWeek ? initialArtists : artists;
  ...
  }, [currentWeekStart, initialArtists, artists]);
