      ...
      <main id="main-content" className={mainContainer}>
        <div className={pageHeader}>
          ...
          <p>
            ...
            網站、生日應援地圖及場地資訊服務的基本約款，規範 STELLAR 團隊與用戶的關係。
          </p>
          <p>
            使用、瀏覽、註冊或投稿前，請您先完整閱讀並確認您同意本協議的全部內容；如有任何不同意之處，請勿使用
            STELLAR 服務。當您使用 STELLAR
            服務、完成會員註冊或送出投稿時，即代表您已瞭解且同意遵守本協議。
          </p>
          <p>
            個人資料保護相關事項，請參閱{' '}
        ...
        <div className={section}>
          ...
          <ol className={orderedList}>
            ...
            <li>
              ...
              的所有公開頁面，STELLAR
              無法防止第三人將用戶內容（定義請見下方）與您聯想在一起，因此您投稿應援活動、場地或發佈資訊時，均應注意您所揭露的資訊可能導致陌生人或您的親友足以辨識您的真實身份，而可能對您的現實生活產生影響。
            </li>
          </ol>
        </div>
        ...
        <div className={section}>
          ...
          <p className={paragraph}>
            就您利用 STELLAR
            服務發佈或提交之文章、應援活動、場地資料、圖片、社群帳號、聯絡連結及其他內容（以下合稱為「用戶內容」），您得依法享有相關智慧財產權。惟就上述用戶內容及相關智慧財產權，您同意以下事項：
          </p>
          <ol className={orderedList}>
            <li>
              您給予 STELLAR
            ...
            <li>
              STELLAR
              團隊得基於推廣應援文化之目的，主動向活動主辦方或合作店家（以下合稱「內容來源方」）徵得授權後，代為將相關應援活動或場地資訊投稿至平台。STELLAR
              團隊進行前項代理投稿前，應事先取得內容來源方之明示同意（包括但不限於透過社群媒體私訊、電子郵件或其他書面或電子方式為之）。代理投稿之內容以內容來源方所提供或公開揭露之資訊為準，如相關資訊有誤，內容來源方應自行承擔相應責任。
            </li>
          </ol>
        </div>
        ...
        <div className={section}>
          ...
          <p className={paragraph}>您於 STELLAR 發佈的用戶內容不得包含下述資訊：</p>
          <ol className={orderedList}>
            <li>違反 STELLAR 站規、投稿規範或刪文規則中禁止之內容。</li>
            <li>
              與生咖活動或場地相關之虛偽、錯誤、過時且足以誤導他人的資訊（包含但不限於活動時間、地點、費用、購買方式、應援規則、場地地址、容納人數及聯絡方式）。
            </li>
            <li>
              未經當事人同意公開足以識別特定個人的資訊（包含但不限於姓名、電話、社群帳號、電子郵件、住址、身分證字號）。
            </li>
            <li>侵害他人智慧財產權、肖像權、隱私權、名譽權或其他權利之內容。</li>
            <li>
              涉及詐騙、惡意導流、釣魚連結、假票券交易、未經揭露之商業廣告或其他足以危害用戶財產與資訊安全之內容。
            </li>
            <li>涉及騷擾、霸凌、仇恨、歧視、恐嚇、暴力鼓吹或其他違反公共秩序善良風俗之內容。</li>
            ...
            <li>與兒童或青少年涉刑事案件相關，且記載相關當事人姓名或其他足以識別其身分之資訊。</li>
        ...
        <div className={section}>
          ...
          <ol className={orderedList}>
            ...
            <li>
              STELLAR
              提供的場地資訊僅供查詢與聯繫參考，不代表推薦、認證或保證。場地檔期、容納人數、交通資訊、聯絡方式及平台收錄的過往活動紀錄可能不完整或隨時變動，您應於預約或前往前直接向場地確認。
            </li>
            <li>
              STELLAR
              並非場地預約、租借或其他交易的當事人、代理人或居間者。您透過外部網站、社群平台或通訊服務與場地進行的聯繫或交易，應適用該第三方的條款與隱私權政策，相關權利義務及風險由您與該第三方自行處理。
            </li>
            <li>
